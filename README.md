...
The core benefit of DBUF is optimization. Data types can be fine tuned for minimal size or high processing throughput, making it suitable for a wide range of storage, interchange and in-memory use cases.
