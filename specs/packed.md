...
The first 4 bytes of a stream may contain the magic number 0xDFDFDFDF. This value is unique among publicly known magic numbers and will not collide with any valid unicode encoding. It is also the same as two consecutive instances of the most significant bit encoding of [magic_number_packed](./registry/magic_number_packed.md) so it will not collide with any valid DBUF data. Any other occurrences of [magic_number_packed](./registry/magic_number_packed.md) are treated as a normal symbol without special semantics.
...
- [type_map](./registry/type_map.md)
- [type_array](./registry/type_array.md)
- [type_choice](./registry/type_choice.md)
- [type_optional](./registry/type_optional.md)
- [parse_varint](./registry/parse_varint.md)
- [parse_bit_size](./registry/parse_bit_size.md)
- [parse_text](./registry/parse_text.md)
- [parse_type_data_immediate](./registry/parse_type_data_immediate.md)
- [type_array_bit](./registry/type_array_bit.md)
- [type_array_fixed](./registry/type_array_fixed.md)
- [type_array_chunk](./registry/type_array_chunk.md)
- [type_choice_shared](./registry/type_choice_shared.md)
- [type_choice_select](./registry/type_choice_select.md)
